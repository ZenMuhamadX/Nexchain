...
export const txInterfaceValidator = Joi.object({
	...
	sender: Joi.string().required(), // The address of the sender
	receiver: Joi.string().required(), // The address of the recipient
	...
	isValid: Joi.boolean().optional(), // Indicates if the transaction has been validated (optional)
